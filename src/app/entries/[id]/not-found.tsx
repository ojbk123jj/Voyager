...
/**
 * 让缺失的条目返回正确的 HTTP 404（默认根 not-found.tsx 在并行路由场景下
 * 可能落入 200，单独定义这里能让此分段被正确标记为 404）。
 */
  ...
  return (
    <main className="mx-auto flex min-h-[60vh] max-w-[600px] flex-col items-center justify-center px-8 text-center">
      ...
      <h1 className="mt-2 font-display text-[2rem] font-light text-ink">
        Entry not <em className="italic text-accent">found</em>.
      </h1>
      <p className="mt-3 text-ink-muted">
        This destination doesn’t exist or has been deleted.
      </p>
      <Link
        href="/"
